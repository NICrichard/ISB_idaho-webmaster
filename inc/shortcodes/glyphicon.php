...
add_shortcode( 'glyphicons-display-all', 'idaho_glyphicon_display_all_func' );

function idaho_glyphicon_display_all_func( $atts, $content = '' ) {
	$glyphicons = array(
		'glass',
		'leaf',
		'dog',
	...
	return implode( '', array_map( function ($item) {
		return "<li><span class='glyphicons-class'><span class='glyphicons glyphicons-$item'></span><br>glyphicons glyphicons-$item</span></li>";
	}, $glyphicons ));
}